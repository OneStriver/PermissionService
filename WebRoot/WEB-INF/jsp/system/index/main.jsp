      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          <div class="layui-logo">
            <span style="color:white;font-size:16px;font-weight:bold;">权限管理系统</span>
          </div>
            	...
            	<c:if test="${menuOne.hasMenu && '1' == menuOne.MENU_STATE}">
            		<li data-name="home" class="layui-nav-item">
            			<a href="javascript:void(0)" lay-tips="${menuOne.MENU_NAME }" lay-direction="2">
            				<i class="${(menuOne.MENU_ICON == null || menuOne.MENU_ICON == '') ? 'layui-icon layui-icon-set-fill' : menuOne.MENU_ICON}"></i>
